...
export default function Topbar() {
  return (
    <header className="flex justify-between items-center w-full border-b-4 border-black px-6 py-4 bg-[#F7F5E6]">
  ...
  <span className="text-lg font-extrabold font-display">Professional Info</span>
</div>
